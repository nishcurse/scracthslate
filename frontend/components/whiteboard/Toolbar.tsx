...
export default function Toolbar() {
  ...
  return (
    <div className="absolute left-6 top-1/2 z-40 -translate-y-1/2">
      <div className="relative flex flex-col overflow-hidden border-[3px] border-ink bg-paper shadow-brutal">
        {tools.map((tool, index) => {
          ...
          return (
            <div key={tool.id} className="group relative">
              ...
              <div
                className="
                  pointer-events-none invisible absolute left-[60px] top-1/2
                  z-50 -translate-y-1/2 translate-x-[-4px]
                  whitespace-nowrap border-[2px] border-ink
                  bg-ink px-3 py-2
                  font-mono text-[10px] font-bold uppercase
                  tracking-[0.16em] text-paper
                  opacity-0 shadow-brutal-sm
