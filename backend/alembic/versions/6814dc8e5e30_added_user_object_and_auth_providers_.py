...
Revision ID: 6814dc8e5e30
Revises: b0591cc37bf7
Create Date: 2026-08-02 20:20:19.204040
...
revision: str = '6814dc8e5e30'
down_revision: Union[str, Sequence[str], None] = 'b0591cc37bf7'
...
def upgrade() -> None:
    ...
    op.add_column('boards', sa.Column('owner_id', sa.String(), nullable=False))
    op.create_index(op.f('ix_boards_owner_id'), 'boards', ['owner_id'], unique=False)
    op.create_foreign_key(None, 'boards', 'users', ['owner_id'], ['id'])
